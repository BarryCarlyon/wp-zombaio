...
This plugin works with "Anyone can register" disabled, stopping users signing up without Paying.
...
* Force User Login
* Splash Page/Members only blocking
...
* Fix a UI glitch when the sidebar and/or one or more forms are on a page
