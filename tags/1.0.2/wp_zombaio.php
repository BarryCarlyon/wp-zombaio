...
class wp_zombaio {
	...
	public function admin_notices() {
		...
		if (get_option('users_can_register')) {
			...
			$alert .= '<p>You have <i>Anyone can register</i> enabled, this means people can join your site without Paying!</p>';
			$alert .= '</div>';
			echo $alert;
		}
	}
...
';
	...
	public function admin_page() {
		...
		echo '<img src="' . plugin_dir_url(__FILE__) . 'img/zombaio-logo.png" alt="Zomabio Logo" />';
