...
//			$wizard_prompt .= '<img src="https://www.zombaio.com/images/zombaio-logo.png" style="float: left; margin: 0px 5px;" />';
...
<script src="https://secure.zombaio.com/External/loc-scr/?62803882wf72baa72ab096a7de0da5298cb503928"></script>
<!--End Zombaio 5.6 Code--> 
*/

/*
			$form = isset($form) ? $form : 'full';

			$html .= '<form action="https://secure.zombaio.com/?' . $this->options->site_id . '.' . $id . '.ZOM" method="post">';

			if ($form == 'full') {
				$html .= '<label for="email">Email: <input type="email" id="email" name="Email" /></label>';
				$html .= '<label for="username">Username: <input type="text" id="username" name="username" /></label>';
				$html .= '<label for="password">Password: <input type="password" id="password" name="password" /></label>';
				$html .= '<label for="firstname">First Name: <input type="text" id="firstname" name="firstname" /></label>';
				$html .= '<label for="lastname">Last Name: <input type="text" id="lastname" name="lastname" /></label>';
				$html .= '<label for="address">Address: <input type="text" id="address" name="address" /></label>';
				$html .= '<label for="city">City: <input type="text" id="city" name="city" /></label>';
				$html .= '<label for="postal">Postal: <input type="text" id="postal" name="postal" /></label>';
			} else if ($form == 'half') {
				$html .= '<label for="email">Email: <input type="email" id="email" name="email" /></label>';
				$html .= '<label for="username">Username: <input type="text" id="username" name="username" /></label>';
				$html .= '<label for="password">Password: <input type="password" id="password" name="password" /></label>';
