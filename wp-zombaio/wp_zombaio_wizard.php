...
switch ($step) {
    ...
    case '2':
        ...
        if (!$gw_pass) {
            ...
            echo sprintf(__('<h3>Communications - Postback</h3>'
                . '<p>Now the final step</p>'
                . '<p>Update the <strong>Postback URL (ZScript)</strong> (<a href="#nowhere" onclick="%s">Screenshot</a>) to the following:</p>', 'wp-zombaio'), 'jQuery(\'#wp_zombaio_website_password\').dialog({width: 720});');
